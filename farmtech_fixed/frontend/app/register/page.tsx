...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as Error).message || t.common.registrationFailed)
    }
  }
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-8 shadow-lg">
            <div className="mb-8 text-center">
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">{RP.pageTitle}</h1>
              <p className="text-slate-600 dark:text-slate-400">{RP.pageSubtitle}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 mb-8">
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <svg
                    className="w-5 h-5 text-emerald-500 absolute start-4 top-1/2 -translate-y-1/2"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
              ...
              >
                {isLoading ? RP.loading : t.register.registerButton}
              </button>
            </form>
